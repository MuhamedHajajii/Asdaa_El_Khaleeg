    ...
    this.blogs = [
      {
        post_id: 1,
        post_title:
          'الشؤون الإسلامية في جازان وبالتعاون مع جمعية الدعوة والإرشاد وتوعية الجاليات تختتم الدورة العلمية المتقدمة الثانية في صامطة الشؤون الإسلامية في جازان وبالتعاون مع جمعية الدعوة والإرشاد وتوعية الجاليات تختتم الدورة العلمية المتقدمة الثانية في صامطةالشؤون الإسلامية في جازان وبالتعاون مع جمعية الدعوة والإرشاد وتوعية الجاليات تختتم الدورة العلمية المتقدمة الثانية في صامطة ',
        post_date: '2025-01-01',
        post_content: 'محتوى المدونة 1',
        author_name: 'سلمان بن أحمد العيد',
        category: 'رياضة - تعليم - ثقافة وفن - مقالات',
      },
      {
        post_id: 2,
        post_title: 'تنفيذ حكم القتل تعزيرًا بأحد الجناة في المنطقة الشرقية',
